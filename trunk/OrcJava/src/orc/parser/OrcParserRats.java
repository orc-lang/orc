...
// on Monday, August 4, 2008 at 2:05:05 PM.
...
public final class OrcParserRats extends ParserBase {
  ...
  static final class Chunk1 {
    ...
    Result fWhereExpression;
    Result fWhereExpression$$Star1;
    Result fBarExpression;
    Result fBarExpression$$Star1;
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              while (true) {
                ...
                yyResult = pDefinition$$Choice1(yyRepetition1);
                yyError  = yyResult.select(yyError);
                if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal orc.parser.OrcParserRats.Definition$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pDefinition$$Choice1(final int yyStart) throws IOException {
    Result        yyResult;
  ...
  private Result pGoalExpression(final int yyStart) throws IOException {
    ...
    yyResult = pWhereExpression(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
  ...
  private Result pSemiExpressionTail(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pWhereExpression(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.WhereExpression.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pWhereExpression(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fWhereExpression) 
      yyColumn.chunk1.fWhereExpression = pWhereExpression$1(yyStart);
    return yyColumn.chunk1.fWhereExpression;
  }

  /** Actually parse orc.parser.OrcParserRats.WhereExpression. */
  private Result pWhereExpression$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pBarExpression(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final Expression seed = yyResult.semanticValue();

      yyResult = pWhereExpression$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal 
   * orc.parser.OrcParserRats.WhereExpression$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pWhereExpression$$Star1(final int yyStart) 
    throws IOException {

    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fWhereExpression$$Star1) 
      yyColumn.chunk1.fWhereExpression$$Star1 = pWhereExpression$$Star1$1(yyStart);
    return yyColumn.chunk1.fWhereExpression$$Star1;
  }

  /** Actually parse orc.parser.OrcParserRats.WhereExpression$$Star1. */
  private Result pWhereExpression$$Star1$1(final int yyStart) 
    throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      { // Start scope for p.
        ...
        if (yyResult.hasValue()) {
          ...
          yyResult = pBarExpression(yyResult.index);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            final Expression right = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.BarExpression.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBarExpression(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fBarExpression) 
      yyColumn.chunk1.fBarExpression = pBarExpression$1(yyStart);
    return yyColumn.chunk1.fBarExpression;
  }

  /** Actually parse orc.parser.OrcParserRats.BarExpression. */
  private Result pBarExpression$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pBarExpression$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Pair<Action<Expression>> actions = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal 
   * orc.parser.OrcParserRats.BarExpression$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBarExpression$$Star1(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fBarExpression$$Star1) 
      yyColumn.chunk1.fBarExpression$$Star1 = pBarExpression$$Star1$1(yyStart);
    return yyColumn.chunk1.fBarExpression$$Star1;
  }

  /** Actually parse orc.parser.OrcParserRats.BarExpression$$Star1. */
  private Result pBarExpression$$Star1$1(final int yyStart) 
    throws IOException {
    ...
    yyResult = pBarExpressionTail(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final Action<Expression> v$el$1 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.BarExpressionTail.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBarExpressionTail(final int yyStart) throws IOException {
    Result             yyResult;
    Action<Expression> yyValue;
    ParseError         yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pSeqExpression(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Expression right = yyResult.semanticValue();
  ...
  private Result pSeqExpression$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          final Pattern v$el$2 = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.Sequent.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pSequent(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fSequent) 
      yyColumn.chunk1.fSequent = pSequent$1(yyStart);
    return yyColumn.chunk1.fSequent;
  }

  /** Actually parse orc.parser.OrcParserRats.Sequent. */
  private Result pSequent$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            yyResult = pSequent$$Star1(yyResult.index);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
              final Pair<List<Pattern>> curried0 = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal orc.parser.OrcParserRats.Sequent$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pSequent$$Choice1(final int yyStart) throws IOException {
    Result        yyResult;
    List<Pattern> yyValue;
    ParseError    yyError = ParseError.DUMMY;
  ...
  /**
   * Parse synthetic nonterminal orc.parser.OrcParserRats.Sequent$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pSequent$$Star1(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fSequent$$Star1) 
      yyColumn.chunk2.fSequent$$Star1 = pSequent$$Star1$1(yyStart);
    return yyColumn.chunk2.fSequent$$Star1;
  }

  /** Actually parse orc.parser.OrcParserRats.Sequent$$Star1. */
  private Result pSequent$$Star1$1(final int yyStart) throws IOException {
    Result              yyResult;
    Pair<List<Pattern>> yyValue;
    ParseError          yyError = ParseError.DUMMY;

    // Alternative 1.

    yyResult = pSequent$$Choice1(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final List<Pattern> v$el$2 = yyResult.semanticValue();

      yyResult = pSequent$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Pair<List<Pattern>> v$3 = yyResult.semanticValue();

        yyValue = new Pair<List<Pattern>>(v$el$2, v$3);
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.Disjunction.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pDisjunction(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fDisjunction) 
      yyColumn.chunk2.fDisjunction = pDisjunction$1(yyStart);
    return yyColumn.chunk2.fDisjunction;
  }

  /** Actually parse orc.parser.OrcParserRats.Disjunction. */
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.Conjunction.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pConjunction(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fConjunction) 
      yyColumn.chunk2.fConjunction = pConjunction$1(yyStart);
    return yyColumn.chunk2.fConjunction;
  }

  /** Actually parse orc.parser.OrcParserRats.Conjunction. */
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.Comparison.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pComparison(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fComparison) 
      yyColumn.chunk2.fComparison = pComparison$1(yyStart);
    return yyColumn.chunk2.fComparison;
  }

  /** Actually parse orc.parser.OrcParserRats.Comparison. */
  private Result pComparison$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.Sum.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  private Result pSumTail(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pProduct(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Expression right = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.Product.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pProduct(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fProduct) 
      yyColumn.chunk2.fProduct = pProduct$1(yyStart);
    return yyColumn.chunk2.fProduct;
  }

  /** Actually parse orc.parser.OrcParserRats.Product. */
  private Result pProduct$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pProduct$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Pair<Action<Expression>> actions = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal orc.parser.OrcParserRats.Product$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pProduct$$Star1(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fProduct$$Star1) 
      yyColumn.chunk2.fProduct$$Star1 = pProduct$$Star1$1(yyStart);
    return yyColumn.chunk2.fProduct$$Star1;
  }

  /** Actually parse orc.parser.OrcParserRats.Product$$Star1. */
  private Result pProduct$$Star1$1(final int yyStart) throws IOException {
    Result                   yyResult;
    Pair<Action<Expression>> yyValue;
    ParseError               yyError = ParseError.DUMMY;
  ...
  private Result pProductTail(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pSigned(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Expression right = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.Signed.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pSigned(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fSigned) 
      yyColumn.chunk2.fSigned = pSigned$1(yyStart);
    return yyColumn.chunk2.fSigned;
  }

  /** Actually parse orc.parser.OrcParserRats.Signed. */
  private Result pSigned$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pBasicExpression(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fBasicExpression) 
      yyColumn.chunk2.fBasicExpression = pBasicExpression$1(yyStart);
    return yyColumn.chunk2.fBasicExpression;
  }
  ...
  private Result pSignedIntegerToken(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fSignedIntegerToken) 
      yyColumn.chunk3.fSignedIntegerToken = pSignedIntegerToken$1(yyStart);
    return yyColumn.chunk3.fSignedIntegerToken;
  }
  ...
  private Result pIntegerToken(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fIntegerToken) 
      yyColumn.chunk3.fIntegerToken = pIntegerToken$1(yyStart);
    return yyColumn.chunk3.fIntegerToken;
  }
  ...
  private Result pIntegerToken$$Star1(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fIntegerToken$$Star1) 
      yyColumn.chunk3.fIntegerToken$$Star1 = pIntegerToken$$Star1$1(yyStart);
    return yyColumn.chunk3.fIntegerToken$$Star1;
  }
