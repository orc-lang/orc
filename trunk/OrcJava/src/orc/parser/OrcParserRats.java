...
// on Saturday, September 6, 2008 at 9:35:05 PM.
...
public final class OrcParserRats extends ParserBase {
  ...
  private Result pGoalExpression(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fGoalExpression) 
      yyColumn.chunk1.fGoalExpression = pGoalExpression$1(yyStart);
    return yyColumn.chunk1.fGoalExpression;
  }

  /** Actually parse orc.parser.OrcParserRats.GoalExpression. */
  private Result pGoalExpression$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
