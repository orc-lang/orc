...
// on Friday, August 8, 2008 at 7:31:46 PM.
...
public final class OrcParserRats extends ParserBase {
  ...
  static final class Chunk1 {
    ...
    Result fNaturalDisjunction;
  }

  /** Chunk 2 of memoized results. */
  static final class Chunk2 {
    Result fNaturalConjunction;
    Result fNaturalComparison;
    Result fDisjunction;
    Result fConjunction;
    Result fComparison;
    Result fComparable;
  ...
  private Result pMaybeWhereExpression$1(final int yyStart) 
    ...
    yyResult = pNaturalDisjunction(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  private Result pWhereExpression(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        yyResult = pWhereExpressionTail(yyRepetition1);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        { // Start scope for p.
          ...
          if (yyResult.hasValue()) {
            ...
            yyResult = pMaybeSeqExpression(yyResult.index);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
              final Expression right = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.NaturalDisjunction.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pNaturalDisjunction(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fNaturalDisjunction) 
      yyColumn.chunk1.fNaturalDisjunction = pNaturalDisjunction$1(yyStart);
    return yyColumn.chunk1.fNaturalDisjunction;
  }

  /** Actually parse orc.parser.OrcParserRats.NaturalDisjunction. */
  private Result pNaturalDisjunction$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pNaturalConjunction(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final Expression left = yyResult.semanticValue();
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pNaturalDisjunction(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          final Expression right = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.NaturalConjunction.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pNaturalConjunction(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fNaturalConjunction) 
      yyColumn.chunk2.fNaturalConjunction = pNaturalConjunction$1(yyStart);
    return yyColumn.chunk2.fNaturalConjunction;
  }

  /** Actually parse orc.parser.OrcParserRats.NaturalConjunction. */
  private Result pNaturalConjunction$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    yyResult = pNaturalComparison(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final Expression left = yyResult.semanticValue();
      ...
      if (yyResult.hasValue()) {
        ...
        yyResult = pNaturalConjunction(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          final Expression right = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.NaturalComparison.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pNaturalComparison(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fNaturalComparison) 
      yyColumn.chunk2.fNaturalComparison = pNaturalComparison$1(yyStart);
    return yyColumn.chunk2.fNaturalComparison;
  }

  /** Actually parse orc.parser.OrcParserRats.NaturalComparison. */
  private Result pNaturalComparison$1(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pNaturalComparator(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.NaturalComparator.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pNaturalComparator(final int yyStart) throws IOException {
    Result          yyResult;
    ...
    yyResult = pNaturalComparator$$Choice1(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal 
   * orc.parser.OrcParserRats.NaturalComparator$$Choice1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pNaturalComparator$$Choice1(final int yyStart) 
    throws IOException {
