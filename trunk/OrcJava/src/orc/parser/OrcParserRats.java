...
// on Tuesday, September 23, 2008 at 2:36:38 PM.
...
public final class OrcParserRats extends ParserBase {
  ...
  static final class Chunk3 {
    ...
    Result fMaybeExponent$$Star1;
    Result fMaybeSigned;
    Result fDotExpression;
    Result fDotExpression$$Star1;
    Result fLiteral;
    Result fCallTail;
  ...
  private Result pGoalExpression(final int yyStart) throws IOException {
    ...
    yyResult = pSemiExpression(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.SemiExpression.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pSemiExpression(final int yyStart) throws IOException {
    Result                   yyResult;
    int                      yyRepetition1;
  ...
  private Result pSafeMaybeSeqExpression$1(final int yyStart) 
    ...
    yyResult = pSafeIfThenElse(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.SafeIfThenElse.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pSafeIfThenElse(final int yyStart) throws IOException {
    Result     yyResult;
    Expression yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyResult = pMaybeSeqExpression(yyChoice1);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            final Expression consequent = yyResult.semanticValue();
          ...
          yyResult = pSafeMaybeSeqExpression(yyChoice1);
          yyError  = yyResult.select(yyError);
          if (yyResult.hasValue()) {
            final Expression consequent = yyResult.semanticValue();
  ...
  private Result pMaybeExponent(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fMaybeExponent) 
      yyColumn.chunk3.fMaybeExponent = pMaybeExponent$1(yyStart);
    return yyColumn.chunk3.fMaybeExponent;
  }
  ...
  private Result pMaybeExponent$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pMaybeExponent$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Pair<Action<Expression>> actions = yyResult.semanticValue();
  ...
  /**
   * Parse synthetic nonterminal 
   * orc.parser.OrcParserRats.MaybeExponent$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pMaybeExponent$$Star1(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fMaybeExponent$$Star1) 
      yyColumn.chunk3.fMaybeExponent$$Star1 = pMaybeExponent$$Star1$1(yyStart);
    return yyColumn.chunk3.fMaybeExponent$$Star1;
  }

  /** Actually parse orc.parser.OrcParserRats.MaybeExponent$$Star1. */
  private Result pMaybeExponent$$Star1$1(final int yyStart) 
    throws IOException {
    ...
    yyResult = pExponentTail(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final Action<Expression> v$el$1 = yyResult.semanticValue();
  ...
  private Result pDotExpression(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fDotExpression) 
      yyColumn.chunk3.fDotExpression = pDotExpression$1(yyStart);
    return yyColumn.chunk3.fDotExpression;
  }
  ...
  private Result pDotExpression$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pDotExpression$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /**
   * Parse synthetic nonterminal 
   * orc.parser.OrcParserRats.DotExpression$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pDotExpression$$Star1(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fDotExpression$$Star1) 
      yyColumn.chunk3.fDotExpression$$Star1 = pDotExpression$$Star1$1(yyStart);
    return yyColumn.chunk3.fDotExpression$$Star1;
  }

  /** Actually parse orc.parser.OrcParserRats.DotExpression$$Star1. */
  private Result pDotExpression$$Star1$1(final int yyStart) 
    throws IOException {
  ...
  private Result pBasicExpression(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pCallTail(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Pair<Action<Expression>> tail = yyResult.semanticValue();
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.DotTail.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pDotTail(final int yyStart) throws IOException {
    Result             yyResult;
    Action<Expression> yyValue;
    ParseError         yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          final Pair<Action<Expression>> call = yyResult.semanticValue();

          yyValue = new Action<Expression>() {
            public Expression run(Expression left) {
              Expression yyValue = new Dot(left, right);
              yyValue = at(left, yyCount, yyValue);
              return apply(call, yyValue);
            }
          };
  ...
  private Result pCallTail(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fCallTail) 
      yyColumn.chunk3.fCallTail = pCallTail$1(yyStart);
    return yyColumn.chunk3.fCallTail;
  }
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue()) {
          ...
          yyValue = new Pair<Action<Expression>>(
  ...
  private Result pConsPattern(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fConsPattern) 
      yyColumn.chunk4.fConsPattern = pConsPattern$1(yyStart);
    return yyColumn.chunk4.fConsPattern;
  }
  ...
  private Result pBasicPattern(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fBasicPattern) 
      yyColumn.chunk4.fBasicPattern = pBasicPattern$1(yyStart);
    return yyColumn.chunk4.fBasicPattern;
  }
  ...
  private Result pType(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk4) yyColumn.chunk4 = new Chunk4();
    if (null == yyColumn.chunk4.fType) 
      yyColumn.chunk4.fType = pType$1(yyStart);
    return yyColumn.chunk4.fType;
  }
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.Word.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse orc.parser.OrcParserRats.Word. */
