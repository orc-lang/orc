...
public final class OrcParserRats extends ParserBase {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue()) {
            ...
            if (yyResult.hasValue()) {
              ...
              yyResult = pHASTYPE(yyResult.index);
              yyError  = yyResult.select(yyError);
              if (yyResult.hasValue()) {
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.BOOLEAN.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.STRING.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.TOP.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTOP(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    int        yyValue;
    ...
    // Done.
    yyError = yyError.select("TOP expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.BOT.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBOT(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    int        yyValue;
    ...
    // Done.
    yyError = yyError.select("BOT expected", yyStart);
    return yyError;
  }
  ...
  /**
   * Parse nonterminal orc.parser.OrcParserRats.HASTYPE.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pHASTYPE(final int yyStart) throws IOException {
    int        yyC;
    int        yyIndex;
    Result     yyResult;
    int        yyValue;
    ...
    // Done.
    yyError = yyError.select("HASTYPE expected", yyStart);
    return yyError;
  }
