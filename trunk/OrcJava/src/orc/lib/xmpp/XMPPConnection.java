...
/**
 * XMPP protocol support starts here. I wish I could just use our Java sites to
 * generate this automatically, but there are a few methods in the API which
 * require asynchronous behavior and so must be implemented as Orc sites.
 * 
 * @author quark
 */
