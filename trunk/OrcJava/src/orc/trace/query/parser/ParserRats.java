...
// on Monday, August 18, 2008 at 3:39:26 PM.
...
public final class ParserRats extends ParserBase {
  ...
  static final class Chunk1 {
    ...
    Result fRegexp;
    Result fNegation;
    Result fBasicPredicate;
    Result fPattern;
    Result fBasicPattern;
    Result fBasicPattern$$Star1;
    Result fExponent;
  ...
  /**
   * Parse nonterminal orc.trace.query.parser.ParserRats.Regexp.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pRegexp(final int yyStart) throws IOException {
    ParserRatsColumn yyColumn = (ParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fRegexp) 
      yyColumn.chunk1.fRegexp = pRegexp$1(yyStart);
    return yyColumn.chunk1.fRegexp;
  }

  /** Actually parse orc.trace.query.parser.ParserRats.Regexp. */
  private Result pRegexp$1(final int yyStart) throws IOException {
    Result     yyResult;
    Predicate  yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  private Result pNegation$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pBasicPredicate(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final Predicate p = yyResult.semanticValue();
  ...
  private Result pBasicPredicate(final int yyStart) throws IOException {
    ParserRatsColumn yyColumn = (ParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fBasicPredicate) 
      yyColumn.chunk1.fBasicPredicate = pBasicPredicate$1(yyStart);
    return yyColumn.chunk1.fBasicPredicate;
  }

  /** Actually parse orc.trace.query.parser.ParserRats.BasicPredicate. */
  private Result pBasicPredicate$1(final int yyStart) throws IOException {
    Result     yyResult;
    Predicate  yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue("Current")) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          final Term p = yyResult.semanticValue();
    ...
    // Done.
    yyError = yyError.select("basic predicate expected", yyStart);
    return yyError;
  }
  ...
  private Result pBasicPattern$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pBasicPattern$$Star1(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
   ...
   * orc.trace.query.parser.ParserRats.BasicPattern$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pBasicPattern$$Star1(final int yyStart) throws IOException {
    ParserRatsColumn yyColumn = (ParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fBasicPattern$$Star1) 
      yyColumn.chunk1.fBasicPattern$$Star1 = pBasicPattern$$Star1$1(yyStart);
    return yyColumn.chunk1.fBasicPattern$$Star1;
  }

  /** Actually parse orc.trace.query.parser.ParserRats.BasicPattern$$Star1. */
  private Result pBasicPattern$$Star1$1(final int yyStart) 
    throws IOException {
  ...
  private Result pSignedIntegerToken(final int yyStart) throws IOException {
    ParserRatsColumn yyColumn = (ParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk1) yyColumn.chunk1 = new Chunk1();
    if (null == yyColumn.chunk1.fSignedIntegerToken) 
      yyColumn.chunk1.fSignedIntegerToken = pSignedIntegerToken$1(yyStart);
    return yyColumn.chunk1.fSignedIntegerToken;
  }
  ...
  /**
   * Parse nonterminal orc.trace.query.parser.ParserRats.WordToken.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /**
   * Parse nonterminal orc.trace.query.parser.ParserRats.PLUS.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
