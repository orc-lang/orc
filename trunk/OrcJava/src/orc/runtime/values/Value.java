...
public abstract class Value implements Future {
	 ...
	 * @param caller
	 */
	public void uncons(Token caller) throws TokenException {
		throw new MessageNotUnderstoodException("Cons deconstructor");
	}
	
	public void unnil(Token caller) throws TokenException {
		throw new MessageNotUnderstoodException("Cons deconstructor");
	}
