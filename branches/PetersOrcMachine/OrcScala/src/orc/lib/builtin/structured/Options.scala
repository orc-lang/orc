...
object NoneConstructor extends TotalSite0 with TypedSite with DirectTotalSite {
...
object SomeConstructor extends TotalSite1 with TypedSite with DirectTotalSite {
