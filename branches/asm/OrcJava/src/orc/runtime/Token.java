...
public class Token implements Serializable, Locatable {
	...
	/* stand in for handling java exceptions.  in reality, we need to compare against JavaExceptions!!! */
	public void thrownJavaException(Throwable e){
		JavaException problem = new JavaException(e);
