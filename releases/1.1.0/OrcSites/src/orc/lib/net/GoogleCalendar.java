...
public class GoogleCalendar {
	 ...
	 */
	public static GoogleCalendar authenticate(final OAuthProvider provider, final String consumer) throws Pausable, Exception {
	...
	private static <E> E runThreaded(final Callable<E> thunk) throws Pausable, IOException, ServiceException {
		try {
	...
	public CalendarEventFeed getEvents(final DateTime start, final DateTime end) throws Pausable, IOException, ServiceException {
