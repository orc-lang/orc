...
/**
 * Holds references to objects identified by unique string keys. Each key is
 * associated with a handle; a handle's keys can be deleted en masse.
 *
 * @param <H> handle type
 * @param <V> value type
 * @author quark
...
public class Globals<H, V> {
    ...
    /**
     * Store a global, using an existing name. Only use this if you are
     * confident the name is globally unique, i.e. it's some form of GUID.
     * Returns false if the key is already in use.
     */
