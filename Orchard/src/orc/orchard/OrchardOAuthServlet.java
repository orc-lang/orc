...
public class OrchardOAuthServlet extends HttpServlet {
    ...
    /**
     * Adds this accessor to the Orc engine globals for retrieval when
     * authorization callback is received. This is not idempotent, only call
     * this method once per auth request.
     *
    ...
    public static String addToGlobalsAndGetCallbackURL(final OAuthAccessor accessor, final LinkedBlockingQueue mbox, final Job job) throws IOException {
        ...
        /*
         * 'Twould be nice to figure out the callback URL automatically from the
         * servlet context, but not possible with the Servlet API.
         */
