...
object DatatypeBuilder extends TotalSite with TypedSite with DirectTotalSite {
...
class DatatypeConstructor(arity: Int, tag: Tag) extends TotalSite with DirectTotalSite {
...
class DatatypeExtractor(tag: Tag) extends PartialSite1 with DirectPartialSite {
