//
// ToJavaRuntime.scala -- Scala class ToJavaRuntime
// Project OrcScala
//
...
class ToJavaRuntime(private[tojava] val runtime: Orc) {
  ...
  final def stage(s: Schedulable) = runtime.stage(s)
  final def stage(s: Schedulable, a: Schedulable) = runtime.stage(s, a)
