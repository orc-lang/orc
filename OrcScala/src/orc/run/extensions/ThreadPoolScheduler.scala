...
// $Id$
//
// Created by amin on Dec 31, 2010.
//
 ...
 * modified by amin on Friday, December 31 2010
 */
class OrcResizableThreadPoolScheduler(maxSiteThreads : Int, protected val terminate: Boolean,
      ...
      while (true) {
        this.synchronized {
          ...
          if (!suspending) {
            ...
            if (activeBlocked > maxSiteThreads) {
              throw new AssertionError("Reached maximum number of site threads.")
            }
