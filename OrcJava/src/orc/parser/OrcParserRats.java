...
// on Tuesday, August 12, 2008 at 12:47:23 PM.
...
public final class OrcParserRats extends ParserBase {
  ...
  private Result pCons(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk3.fCons) 
      yyColumn.chunk3.fCons = pCons$1(yyStart);
    return yyColumn.chunk3.fCons;
  }
  ...
  private Result pMaybeProduct(final int yyStart) throws IOException {
    OrcParserRatsColumn yyColumn = (OrcParserRatsColumn)column(yyStart);
    if (null == yyColumn.chunk3) yyColumn.chunk3 = new Chunk3();
    if (null == yyColumn.chunk3.fMaybeProduct) 
      yyColumn.chunk3.fMaybeProduct = pMaybeProduct$1(yyStart);
    return yyColumn.chunk3.fMaybeProduct;
  }
  ...
  private Result pLiteral(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk4.fLiteral) 
      yyColumn.chunk4.fLiteral = pLiteral$1(yyStart);
    return yyColumn.chunk4.fLiteral;
  }
