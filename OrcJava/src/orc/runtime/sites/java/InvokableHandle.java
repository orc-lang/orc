...
public abstract class InvokableHandle<M> {
	private static int arity(Object[] things) {
	...
	public static enum Type {
		...
		LongObject, IntegerObject, ShortObject, ByteObject,
		DoubleObject, FloatObject,
		CharacterObject, BooleanObject,
		BigInteger, BigDecimal,
	};
	private final static HashMap<Class, Type> CLASS_TYPES;
	private final static boolean COERCABLE[][];
	private static void allowCoercion(Type from, Type to) {
	...
	public static Type classToType(Class type) {
		Type out = CLASS_TYPES.get(type);
		return out == null ? Type.Object : out;
	}
	
	private static boolean resolve(Class[] parameterTypes, Object[] arguments) {
	...
	private static void coerce(Class[] parameterTypes, Object[] arguments) {
	 ...
	 */
	public static Object coerce(Class to, Object o) {
		if (o == null) {
			return null;
		} else if (o instanceof BigInteger) {
			BigInteger b = (BigInteger)o;
			switch (classToType(to)) {
			case Double: return b.doubleValue();
			case Float: return b.floatValue();
			case Long: return b.longValue();
			case Integer: return b.intValue();
			case Short: return b.shortValue();
			case Byte: return b.byteValue();
			}
	 ...
	 */
	public static boolean isCoercableFrom(Class to, Object o) {
	...
	private List<M>[] byArity = (List<M>[])(new List[11]);;
	public String name;
	public InvokableHandle(String name, M[] invokables) {
		this.name = name;
		for (M m : invokables) {
			int arity = arity(getParameterTypes(m));
