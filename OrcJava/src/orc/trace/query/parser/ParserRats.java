...
// on Tuesday, August 19, 2008 at 6:09:15 PM.
...
public final class ParserRats extends ParserBase {
  ...
  private Result pUnaryTemporal$1(final int yyStart) throws IOException {
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = new UntilPredicate(TruePredicate.singleton, p);
    ...
    if (yyResult.hasValue()) {
      ...
      if (yyResult.hasValue()) {
        ...
        yyValue = new ReleasePredicate(FalsePredicate.singleton, p);
  ...
  private Result pBasicPattern$$Star1$1(final int yyStart) 
    ...
    if (yyResult.hasValue()) {
      ...
      yyResult = pVariable(yyResult.index);
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
  ...
  /** Actually parse orc.trace.query.parser.ParserRats.Variable. */
