...
public class NewContinuation extends Expression {
    ...
    public NewContinuation(final Expression[] capturedVariables, final RootNode rootNode) {
    ...
    public Object execute(final VirtualFrame frame) {
        ...
        /*
         * Logger.info(() -> "Allocating closure with " +
         * capturedVariables.length + " captured variables and initial values "
