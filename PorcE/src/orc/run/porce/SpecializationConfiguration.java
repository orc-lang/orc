...
public abstract class SpecializationConfiguration {
	...
	*/
	...
	public static final int InternalCallMaxCacheSize =
		Integer.parseInt(System.getProperty("orc.porce.cache.internalCallMaxCacheSize", "2"));
	@CompilationFinal
	public static final int ExternalDirectCallMaxCacheSize =
		Integer.parseInt(System.getProperty("orc.porce.cache.externalDirectCallMaxCacheSize", "4"));
	@CompilationFinal
	public static final int ExternalCPSCallMaxCacheSize =
		Integer.parseInt(System.getProperty("orc.porce.cache.externalCPSCallMaxCacheSize", "4"));
