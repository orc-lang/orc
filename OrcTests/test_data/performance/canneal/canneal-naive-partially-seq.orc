...
def run(netlist) =
    ...
    def anneal(temperature, tempStep) =
    	upto(swapsPerTemp) >> Sequentialize() >> (
...
benchmarkSized("Canneal-naive-partially-seq", nTempSteps * swapsPerTemp, { netlist.resetLocations() >> netlist }, run, { _ >> false {- TODO: Implement checking -} })
