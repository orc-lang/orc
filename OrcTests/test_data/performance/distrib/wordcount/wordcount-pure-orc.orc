...
--val numRepetitions = Read(JavaSys.getProperty("orc.test.numRepetitions", (if NumberOfRuntimeEngines() :> 3 then "20" else if NumberOfRuntimeEngines() :> 1 then "10" else "4")))
