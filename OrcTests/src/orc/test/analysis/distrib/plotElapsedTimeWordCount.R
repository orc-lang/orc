...
baselineTimeSummaryRc$program <- recode(baselineTimeSummaryRc$program, "WordCount.java"="Java 1 thr", "wordcount-pure-orc.orc"="pure Orc", "wordcount-mixed-orc-java.orc"="Java+Orc", "WordCountHadoop.java"="Hadoop")
