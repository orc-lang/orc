...
public class PorcExamplesTest {
    ...
    public static Test suite() {
        ...
        return TestUtils.buildSuite(PorcExamplesTest.class.getSimpleName(), (s, t, f, e, b) -> new PorcExamplesTestCase(s, t, f, e, b), bindings, Paths.get("test_data"), Paths.get("../OrcExamples"));
    }

    public static class PorcExamplesTestCase extends OrcTestCase {
        public PorcExamplesTestCase(final String suiteName1, final String testName, final Path orcFile1, final ExpectedOutput expecteds1, final OrcBindings bindings1) {
