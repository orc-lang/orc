...
package orc.imp.tokenColorer;

import orc.imp.parser.OrcLexer.OrcToken;
...
public class OrcTokenColorer extends TokenColorerBase implements ITokenColorer {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.imp.services.base.TokenColorerBase#getColoring(org.eclipse.imp.parser.IParseController, java.lang.Object)
	 */
	@Override
