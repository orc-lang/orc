...
/**
 * Provides lexical scanning for the currently parsed string in the given
 * ParseController.
 *
...
public class OrcLexer implements Iterable<OrcLexer.OrcToken> {
    ...
    public enum TokenType {
        ...
        NULL_LITERAL,
        /**
         * Lexeme that follows identifier rules, but it might be a keyword. This
         * can be refined into IDENTIFIER or KEYWORD token types.
         */
        ...
        COMMENT_ENDLINE,
        /**
         * Comment bracketed by "{-" "-}". These brackets are included in the
         * token. Despite the name, the comment could be on one line.
         */
        COMMENT_MULTILINE,
    ...
    /**
     * Constructs an object of class OrcLexer, which will scan the currently
     * parsed string in the given ParseController.
     *
    ...
    /**
     * Get the first token found at a given offset in the currently parsed
     * string.
     *
    ...
    /**
     * Returns an iterator over OrcTokens in the currently parsed string. This
     * method skips whitespace, but returns comments.
     *
