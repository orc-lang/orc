...
public class OrcTreeModelBuilder extends TreeModelBuilderBase {
     ...
     * @param category integer category of model tree node (currently used for
     *            sorting -- sort on category then label text)
    ...
    /**
     * Creates a child of the current node in the model tree. Equivalent to
     * <code>createSubItem(n, DEFAULT_CATEGORY)</code>
     *
     * @param n AST node to associate with this node in the model tree
     * @return ModeTreeNode created with current node as parent
     * @see org.eclipse.imp.services.base.TreeModelBuilderBase#createSubItem(java.lang.Object)
    ...
    /**
     * Creates a node for the model tree which has no parent node. Equivalent to
     * <code>createTopItem(n, DEFAULT_CATEGORY)</code>
     *
     * @param n AST node to associate with this node in the model tree
     * @return ModeTreeNode created with no parent
     * @see org.eclipse.imp.services.base.TreeModelBuilderBase#createTopItem(java.lang.Object)
    ...
    /**
     * Creates a child of the current node in the model tree, then makes it the
     * current node. Thus, future nodes will be build in this sub-tree, until
     * {@link #popSubItem()} is invoked.
     *
     * @param n AST node to associate with this node in the model tree
     * @param category integer category of model tree node (currently used for
     *            sorting -- sort on category then label text)
     ...
     * Creates a child of the current node in the model tree, then makes it the
     * current node. Thus, future nodes will be build in this sub-tree, until
     * {@link #popSubItem()} is invoked. Equivalent to
     * <code>pushSubItem(n, DEFAULT_CATEGORY)</code>
     *
     * @param n AST node to associate with this node in the model tree
     * @return ModeTreeNode created with previous current node as parent
     * @see org.eclipse.imp.services.base.TreeModelBuilderBase#pushSubItem(java.lang.Object)
