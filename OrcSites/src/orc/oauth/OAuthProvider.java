...
/**
 * Abstract out the details of OAuth authentication so that sites can use it
 * without relying on a particular platform (UI or web).
 *
 * @author quark
 */
public abstract class OAuthProvider extends DotSite {
    ...
    // * @throws Exception
    // */
    // public OAuthAccessor authenticate(final String name, final
    // List<OAuth.Parameter> request) throws Exception {
    // throw new
    // AssertionError("Must override OAuthProvider#authenticate(String)");
    // }

    // public final OAuthConsumer getConsumer(final String name) throws
    // OAuthException {
