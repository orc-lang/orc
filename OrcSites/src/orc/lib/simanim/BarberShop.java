//
// BarberShop.java -- Java class BarberShop
// Project OrcSites
//
...
public class BarberShop extends JPanel {
    ...
    public static Image sauceImg = Toolkit.getDefaultToolkit().getImage(BarberShop.class.getResource("sauce.png"));
    ...
    Rectangle2D.Double shopBound = new Rectangle2D.Double(0, 0, 0.8 * winWidth, 0.8 * winWidth);
    public static Image bChairImg = Toolkit.getDefaultToolkit().getImage(BarberShop.class.getResource("barbChair.png"));
    public static Image wChairImg = Toolkit.getDefaultToolkit().getImage(BarberShop.class.getResource("chair.png"));
    public static Image cReg1Img = Toolkit.getDefaultToolkit().getImage(BarberShop.class.getResource("register1.png"));
    public static Image cReg2Img = Toolkit.getDefaultToolkit().getImage(BarberShop.class.getResource("register2.png"));
    public static Image scissorImg = Toolkit.getDefaultToolkit().getImage(BarberShop.class.getResource("scissors.png"));
    public static Image razorImg = Toolkit.getDefaultToolkit().getImage(BarberShop.class.getResource("razor.png"));
    public static Image clipperImg = Toolkit.getDefaultToolkit().getImage(BarberShop.class.getResource("clippers.png"));
    public static Image monkeyImg = Toolkit.getDefaultToolkit().getImage(BarberShop.class.getResource("monkey.png"));

    /**
     * Barber can be sleeping=0, cutting hair=1, at register=2
     * 
     * @param bID
     * @param state
     * @return
     */
    public boolean setBarberState(final int bID, final int state) {
        barbState[bID - 1] = state;
        return true;
    }

    public int newTransition(final int id) {
        int ii;
    ...
    public boolean endTransition(final int tt) {
        changes[tt] = null;
        return true;
    }

    public boolean setTransition(final int tt, final int st) {
        changes[tt].frac = st;
        return true;
    }

    public int lineToChair(int chair, final int id) {
        chair -= 1;
        final int tt = newTransition(id);
    ...
    public int lineToBChair(int chair, final int id) {
        chair -= 1;
        final int tt = newTransition(id);
        changes[tt].startX = 0.5 * baseRad;
        changes[tt].startY = 2 * baseRad;
    ...
    public int chairToBChair(int chair, int bChair, final int id) {
        chair -= 1;
        bChair -= 1;
        final int tt = newTransition(id);
    ...
    public int bChairToLine(int chair, final int id) {
        chair -= 1;
        final int tt = newTransition(id);
    ...
    public int barberToReg(int id) {
        id -= 1;
        final int tt = newTransition(-(1 + id));
     ...
     * @return
     */
    public boolean setChairState(final int chID, final int state) {
     ...
     * @return
     */
    public boolean setBChairState(final int chID, final int state) {
     ...
     * @return
     */
    public boolean pushFloor(final int state) {
        floorList.add(state);
        return true;
    }
     ...
     * @return
     */
    public boolean pushRegister(final int state) {
        regList.add(state);
        return true;
    }
    ...
    public boolean setReg(final boolean open) {
        cashReg = open;
        return open;
    }
     ...
     */
    public BarberShop(final int wCount, final int bCount) {
    ...
    public void paintComponent(final Graphics g) {
        ...
        g2d.drawImage(cashReg ? cReg2Img : cReg1Img, 0, 0, (int) (3 * baseRad), (int) (3 * baseRad), this);
        ...
        for (int ii = 0; ii < bChairState.length; ++ii) {
            ...
            case 1:
                ...
                g2d.rotate(rot);
                g2d.drawImage(clipImg[ii], (int) (-0.5 * baseRad), (int) (-0.5 * baseRad), (int) baseRad, (int) baseRad, this);
                break;
            case 2:
            ...
            g2d.drawImage(bChairImg, (int) (ii * 0.4 * winWidth / bChairState.length), 0, (int) (3 * baseRad), (int) (3 * baseRad), this);
        ...
        for (int ii = 0; ii < chairState.length; ++ii) {
            saveTrans2 = g2d.getTransform();
            g2d.drawImage(wChairImg, (int) (ii * 0.6 * winWidth / chairState.length), 0, (int) (2 * baseRad), (int) (2 * baseRad), this);
        ...
        for (final Integer ii : floorList) {
            paintMonkey(g2d, ii);
        ...
        for (final Integer ii : regList) {
            paintMonkey(g2d, ii);
            g2d.translate(0, baseRad);
        }
        g2d.setTransform(saveTrans);

        for (final Transition change : changes) {
            if (change != null) {
                g2d.translate(change.getX(), change.getY());
                paintMonkey(g2d, change.c);
                g2d.setTransform(saveTrans);
            }
        }
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        final int tt = se.chairToBChair(4, 3, 5);
